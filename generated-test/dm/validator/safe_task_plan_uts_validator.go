...
type SafeTaskPlanUtsRequest struct {
	...
	Issued int16     `json:"issued" form:"issued" xml:"issued" url:"issued" validate:"int" label:"下发状态"`
	Pcap   *string   `json:"pcap" form:"pcap" xml:"pcap" url:"pcap" validate:"string|maxLen:1020" label:"文件名称"`
}
