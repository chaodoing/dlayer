...
type SysRoleRequest struct {
	...
	Title       string `json:"title" form:"title" xml:"title" url:"title" validate:"required|string|maxLen:240" label:"角色名称"`
	Name        string `json:"name" form:"name" xml:"name" url:"name" validate:"required|string|maxLen:240" label:"调用名称"`
	Description string `json:"description" form:"description" xml:"description" url:"description" validate:"required|string|maxLen:480" label:"描述信息"`
	Rules       string `json:"rules" form:"rules" xml:"rules" url:"rules" validate:"required|string|maxLen:32767" label:"角色允许访问"`
