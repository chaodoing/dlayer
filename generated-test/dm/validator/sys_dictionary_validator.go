...
type SysDictionaryRequest struct {
	...
	Name  string `json:"name" form:"name" xml:"name" url:"name" validate:"required|string|maxLen:200" label:"调用名称"`
	Sort  int64  `json:"sort" form:"sort" xml:"sort" url:"sort" validate:"required|int" label:"显示顺序"`
	Note  string `json:"note" form:"note" xml:"note" url:"note" validate:"required|string|maxLen:1020" label:"字典备注"`
}
