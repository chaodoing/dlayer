...
func newSysConfig(db *gorm.DB, opts ...gen.DOOption) sysConfig {
	...
	_sysConfig.ID = field.NewUint32(tableName, "id")
	_sysConfig.Code = field.NewString(tableName, "code")
	_sysConfig.Title = field.NewString(tableName, "title")
	_sysConfig.Sort = field.NewUint32(tableName, "sort")
	_sysConfig.Disabled = field.NewUint8(tableName, "disabled")
	_sysConfig.CreatedAt = field.NewTime(tableName, "created_at")
	_sysConfig.UpdatedAt = field.NewTime(tableName, "updated_at")
	_sysConfig.DeletedAt = field.NewTime(tableName, "deleted_at")
