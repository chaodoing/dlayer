...
func newSysRole(db *gorm.DB, opts ...gen.DOOption) sysRole {
	...
	_sysRole.ID = field.NewUint(tableName, "id")
	_sysRole.Title = field.NewString(tableName, "title")
	_sysRole.Name = field.NewString(tableName, "name")
	_sysRole.Description = field.NewString(tableName, "description")
	_sysRole.Rules = field.NewField(tableName, "rules")
	_sysRole.Sort = field.NewUint(tableName, "sort")
	_sysRole.Disabled = field.NewUint8(tableName, "disabled")
...
type sysRole struct {
	...
	Rules       field.Field  // 角色允许访问
	Sort        field.Uint   // 排序
	Disabled    field.Uint8  // 角色状态
