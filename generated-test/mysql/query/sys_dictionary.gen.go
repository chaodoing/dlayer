...
func newSysDictionary(db *gorm.DB, opts ...gen.DOOption) sysDictionary {
	...
	_sysDictionary.ID = field.NewUint(tableName, "id")
	_sysDictionary.Title = field.NewString(tableName, "title")
	_sysDictionary.Name = field.NewString(tableName, "name")
	_sysDictionary.Sort = field.NewUint(tableName, "sort")
	_sysDictionary.Note = field.NewString(tableName, "note")
...
type sysDictionary struct {
	...
	Sort      field.Uint   // 显示顺序
	Note      field.String // 字典备注
...
type ISysDictionaryDo interface {
	...
	Create(values ...*model.SysDictionary) error
	CreateInBatches(values []*model.SysDictionary, batchSize int) error
	Save(values ...*model.SysDictionary) error
	First() (*model.SysDictionary, error)
	Take() (*model.SysDictionary, error)
	Last() (*model.SysDictionary, error)
	Find() ([]*model.SysDictionary, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SysDictionary, err error)
	FindInBatches(result *[]*model.SysDictionary, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.SysDictionary) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.SysDictionary, error)
	FirstOrCreate() (*model.SysDictionary, error)
	FindByPage(offset int, limit int) (result []*model.SysDictionary, count int64, err error)
