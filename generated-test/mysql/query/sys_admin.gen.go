...
func newSysAdmin(db *gorm.DB, opts ...gen.DOOption) sysAdmin {
	...
	_sysAdmin.ID = field.NewUint(tableName, "id")
	_sysAdmin.RoleID = field.NewUint(tableName, "role_id")
	_sysAdmin.Name = field.NewString(tableName, "name")
	_sysAdmin.Portrait = field.NewString(tableName, "portrait")
	_sysAdmin.Account = field.NewString(tableName, "account")
	_sysAdmin.Password = field.NewString(tableName, "password")
	_sysAdmin.Method = field.NewString(tableName, "method")
	_sysAdmin.Salt = field.NewString(tableName, "salt")
	_sysAdmin.Disabled = field.NewUint8(tableName, "disabled")
	_sysAdmin.CreatedAt = field.NewTime(tableName, "created_at")
	_sysAdmin.UpdatedAt = field.NewTime(tableName, "updated_at")
	_sysAdmin.DeletedAt = field.NewTime(tableName, "deleted_at")
...
type sysAdmin struct {
	...
	ALL       field.Asterisk
	ID        field.Uint   // 主键
	RoleID    field.Uint   // 角色 id
	Name      field.String // 用户姓名
	Portrait  field.String // 用户头像
	Account   field.String // 登录账号
	Password  field.String // 登录密码
	Method    field.String // 密码加密方法
	Salt      field.String // 认证器密钥
	Disabled  field.Uint8  // 用户锁定状态
...
func (s *sysAdmin) updateTableName(table string) *sysAdmin {
	...
	s.RoleID = field.NewUint(table, "role_id")
	s.Name = field.NewString(table, "name")
	s.Portrait = field.NewString(table, "portrait")
...
func (s *sysAdmin) fillFieldMap() {
	...
	s.fieldMap["portrait"] = s.Portrait
