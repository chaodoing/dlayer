...
type SysAdminProfileRequest struct {
	AdminId          uint   `json:"admin_id" form:"admin_id" xml:"admin_id" url:"admin_id" validate:"uint" label:"管理员 id"`
	...
	RealNameVerified uint8  `json:"real_name_verified" form:"real_name_verified" xml:"real_name_verified" url:"real_name_verified" validate:"uint" label:"实名认证 0未认证 1已认证"`
}
