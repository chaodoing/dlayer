...
type SafeEventLogsRequest struct {
	...
	EventType  string    `json:"event_type" form:"event_type" xml:"event_type" url:"event_type" validate:"required|string|maxLen:16" label:"所属事件"`
	PlatformId uint      `json:"platform_id" form:"platform_id" xml:"platform_id" url:"platform_id" validate:"required|uint" label:"来源平台ID"`
