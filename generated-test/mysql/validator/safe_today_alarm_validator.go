...
type SafeTodayAlarmRequest struct {
	...
	EventType string    `json:"event_type" form:"event_type" xml:"event_type" url:"event_type" validate:"required|string|maxLen:16" label:"事件ID"`
	Total     uint      `json:"total" form:"total" xml:"total" url:"total" validate:"uint" label:"事件数量"`
}
