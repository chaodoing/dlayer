...
func newUsers(db *gorm.DB, opts ...gen.DOOption) users {
	...
	_users.DepartmentID = field.NewInt(tableName, "department_id")
	_users.Type = field.NewInt16(tableName, "type")
	...
	_users.RegisterAddress = field.NewString(tableName, "register_address")
	_users.RegisterTime = field.NewTime(tableName, "register_time")
	_users.LastLoginAddress = field.NewString(tableName, "last_login_address")
	_users.LastLoginTime = field.NewTime(tableName, "last_login_time")
...
func (u *users) updateTableName(table string) *users {
	...
	u.DepartmentID = field.NewInt(table, "department_id")
	u.Type = field.NewInt16(table, "type")
	u.Nickname = field.NewString(table, "nickname")
	u.Username = field.NewString(table, "username")
	u.Mobile = field.NewString(table, "mobile")
	u.Password = field.NewString(table, "password")
	u.RegisterAddress = field.NewString(table, "register_address")
	u.RegisterTime = field.NewTime(table, "register_time")
	u.LastLoginAddress = field.NewString(table, "last_login_address")
...
func (u *users) fillFieldMap() {
	...
	u.fieldMap["register_address"] = u.RegisterAddress
	u.fieldMap["register_time"] = u.RegisterTime
	u.fieldMap["last_login_address"] = u.LastLoginAddress
