...
func newOperateLog(db *gorm.DB, opts ...gen.DOOption) operateLog {
	...
	_operateLog.Method = field.NewString(tableName, "method")
	_operateLog.Path = field.NewString(tableName, "path")
	_operateLog.Enctype = field.NewString(tableName, "enctype")
	_operateLog.Query = field.NewString(tableName, "query")
	_operateLog.Body = field.NewField(tableName, "body")
	_operateLog.Remote = field.NewString(tableName, "remote")
	_operateLog.UID = field.NewInt64(tableName, "uid")
...
func (o *operateLog) updateTableName(table string) *operateLog {
	...
	o.Enctype = field.NewString(table, "enctype")
	o.Query = field.NewString(table, "query")
	o.Body = field.NewField(table, "body")
	o.Remote = field.NewString(table, "remote")
...
func (o *operateLog) fillFieldMap() {
	...
	o.fieldMap["enctype"] = o.Enctype
	o.fieldMap["query"] = o.Query
	o.fieldMap["body"] = o.Body
	o.fieldMap["remote"] = o.Remote
