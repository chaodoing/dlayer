...
func newZone(db *gorm.DB, opts ...gen.DOOption) zone {
	...
	_zone.Code = field.NewInt(tableName, "code")
	_zone.Name = field.NewString(tableName, "name")
	_zone.ParentCode = field.NewInt(tableName, "parent_code")
	_zone.Level = field.NewInt16(tableName, "level")
...
type zone struct {
	...
	ParentCode field.Int    // 上级城市
	Level      field.Int16  // 城市等级
...
func (z *zone) updateTableName(table string) *zone {
	...
	z.Code = field.NewInt(table, "code")
	z.Name = field.NewString(table, "name")
	z.ParentCode = field.NewInt(table, "parent_code")
	z.Level = field.NewInt16(table, "level")
...
func (z *zone) fillFieldMap() {
	...
	z.fieldMap["parent_code"] = z.ParentCode
...
type IZoneDo interface {
	...
	Unscoped() IZoneDo
	Create(values ...*model.Zone) error
	CreateInBatches(values []*model.Zone, batchSize int) error
	Save(values ...*model.Zone) error
	First() (*model.Zone, error)
	Take() (*model.Zone, error)
	Last() (*model.Zone, error)
	Find() ([]*model.Zone, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Zone, err error)
	FindInBatches(result *[]*model.Zone, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Zone) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Zone, error)
	FirstOrCreate() (*model.Zone, error)
	FindByPage(offset int, limit int) (result []*model.Zone, count int64, err error)
