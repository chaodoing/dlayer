...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.ID = field.NewInt(tableName, "id")
	_admin.RoleID = field.NewInt(tableName, "role_id")
	_admin.DepartmentID = field.NewInt(tableName, "department_id")
	...
	_admin.Method = field.NewString(tableName, "method")
	_admin.Salt = field.NewString(tableName, "salt")
	_admin.Disabled = field.NewInt16(tableName, "disabled")
	_admin.CreatedAt = field.NewTime(tableName, "created_at")
	_admin.UpdatedAt = field.NewTime(tableName, "updated_at")
	_admin.DeletedAt = field.NewTime(tableName, "deleted_at")
...
func (a *admin) updateTableName(table string) *admin {
	...
	a.DepartmentID = field.NewInt(table, "department_id")
	...
	a.Disabled = field.NewInt16(table, "disabled")
...
func (a *admin) fillFieldMap() {
	...
	a.fieldMap["department_id"] = a.DepartmentID
