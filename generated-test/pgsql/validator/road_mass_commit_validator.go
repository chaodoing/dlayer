...
// RoadMassCommitRequest is the request validator for the road_mass_commit table.
type RoadMassCommitRequest struct {
	...
	SignalCount    int            `json:"signal_count" form:"signal_count" xml:"signal_count" url:"signal_count" validate:"required|int" label:"信号路测众测指标上传次数"`
...
func (RoadMassCommitRequest) ConfigValidation(v *validate.Validation) {
	v.WithScenes(validate.SValues{
		"insert": []string{"Uid", "StartTime", "DoneTime", "StartLongitude", "StartLatitude", "DoneLongitude", "DoneLatitude", "SignalCount", "SpeedCount", "Terminal", "Operator", "NetworkType", "AvgUpload", "AvgDownload", "PeakUpload", "PeakDownload", "Ping", "Jitter", "PacketLoss", "Delay", "Signal", "Sinr", "ImagePhotoIds", "VideoPhotoIds", "Status"},
		"update": []string{"Id", "Uid", "StartTime", "DoneTime", "StartLongitude", "StartLatitude", "DoneLongitude", "DoneLatitude", "SignalCount", "SpeedCount", "Terminal", "Operator", "NetworkType", "AvgUpload", "AvgDownload", "PeakUpload", "PeakDownload", "Ping", "Jitter", "PacketLoss", "Delay", "Signal", "Sinr", "ImagePhotoIds", "VideoPhotoIds", "Status"},
		"delete": []string{"Id"},
	})
}

// Messages defines Chinese validation messages.
func (RoadMassCommitRequest) Messages() map[string]string {
	return validate.MS{
		"float":    "{field}必须是浮点数",
		"int":      "{field}必须是整数",
