...
// RoadCommitIndicatorSignalsRequest is the request validator for the road_commit_indicator_signals table.
type RoadCommitIndicatorSignalsRequest struct {
	Id          int            `json:"id" form:"id" xml:"id" url:"id" validate:"required|int" label:"主键ID"`
	IndicatorId int            `json:"indicator_id" form:"indicator_id" xml:"indicator_id" url:"indicator_id" validate:"required|int" label:"指标数据ID"`
...
func (RoadCommitIndicatorSignalsRequest) ConfigValidation(v *validate.Validation) {
...
func (RoadCommitIndicatorSignalsRequest) Messages() map[string]string {
	return validate.MS{
		"int":      "{field}必须是整数",
