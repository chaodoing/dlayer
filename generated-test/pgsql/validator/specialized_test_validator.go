...
// SpecializedTestRequest is the request validator for the specialized_test table.
type SpecializedTestRequest struct {
...
func (SpecializedTestRequest) ConfigValidation(v *validate.Validation) {
	v.WithScenes(validate.SValues{
		"insert": []string{"TaskId", "PlaceId", "UserId", "Operator", "ZoneCode", "NetworkType", "AvgUpload", "AvgDownload", "PeakUpload", "PeakDownload", "DataState", "SignalStrength", "Sinr", "LossRate", "Delay", "Jitter", "Ping", "Terminal", "Longitude", "Latitude", "ImagePhotoId", "VideoPhotoId", "Location", "LocationDescription", "LocationType"},
		"update": []string{"Id", "TaskId", "PlaceId", "UserId", "Operator", "ZoneCode", "NetworkType", "AvgUpload", "AvgDownload", "PeakUpload", "PeakDownload", "DataState", "SignalStrength", "Sinr", "LossRate", "Delay", "Jitter", "Ping", "Terminal", "Longitude", "Latitude", "ImagePhotoId", "VideoPhotoId", "Location", "LocationDescription", "LocationType"},
		"delete": []string{"Id"},
	})
}

// Messages defines Chinese validation messages.
func (SpecializedTestRequest) Messages() map[string]string {
	return validate.MS{
		"float":    "{field}必须是浮点数",
		"int":      "{field}必须是整数",
