...
// MassServerRequest is the request validator for the mass_server table.
type MassServerRequest struct {
...
func (MassServerRequest) ConfigValidation(v *validate.Validation) {
...
func (MassServerRequest) Messages() map[string]string {
	return validate.MS{
		"int":      "{field}必须是整数",
