...
// RoadMassCommitIndicatorsRequest is the request validator for the road_mass_commit_indicators table.
type RoadMassCommitIndicatorsRequest struct {
...
func (RoadMassCommitIndicatorsRequest) ConfigValidation(v *validate.Validation) {
	v.WithScenes(validate.SValues{
		"insert": []string{"Uid", "CommitId", "Longitude", "Latitude", "ZoneCode", "Location", "Sinr", "Signal", "Delay", "Ping", "Jitter", "PacketLoss"},
		"update": []string{"Id", "Uid", "CommitId", "Longitude", "Latitude", "ZoneCode", "Location", "Sinr", "Signal", "Delay", "Ping", "Jitter", "PacketLoss"},
		"delete": []string{"Id"},
	})
}

// Messages defines Chinese validation messages.
func (RoadMassCommitIndicatorsRequest) Messages() map[string]string {
	return validate.MS{
		"float":    "{field}必须是浮点数",
		"int":      "{field}必须是整数",
