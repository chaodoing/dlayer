...
// MassSignalsRequest is the request validator for the mass_signals table.
type MassSignalsRequest struct {
...
func (MassSignalsRequest) ConfigValidation(v *validate.Validation) {
...
func (MassSignalsRequest) Messages() map[string]string {
	return validate.MS{
		"int":      "{field}必须是整数",
